...
jQuery ->
  ...
  $("#operation_op_prep_start_4i").on('change', ->
    ...
    if raw_time_number - 8 < 0
      pst_time_number = raw_time_number + 24 - 8
    else
      pst_time_number = raw_time_number - 8
    # Adjust the raw time number for cst
    if raw_time_number - 6 < 0
      cst_time_number = raw_time_number + 24 - 6
    else
      cst_time_number = raw_time_number - 6
    # Adjust the raw time number for est
    if raw_time_number - 5 < 0
      est_time_number = raw_time_number + 24 - 5
    else
      est_time_number = raw_time_number - 5
  ...
  $("#operation_op_departure_5i").on('change', ->
    ...
    # Format the time string for display
    pst_op_departure_time = $(".op-prep-start-time .time-preview__pst-container .time").data('time-hour').toString() + ":" + $("#operation_op_departure_5i").val()
    cst_op_departure_time = $(".op-prep-start-time .time-preview__cst-container .time").data('time-hour').toString() + ":" + $("#operation_op_departure_5i").val()
    est_op_departure_time = $(".op-prep-start-time .time-preview__est-container .time").data('time-hour').toString() + ":" + $("#operation_op_departure_5i").val()
  ...
  $("#operation_op_completion_5i").on('change', ->
    ...
    # Format the time string for display
    pst_op_completion_time = $(".op-prep-start-time .time-preview__pst-container .time").data('time-hour').toString() + ":" + $("#operation_op_completion_5i").val()
    cst_op_completion_time = $(".op-prep-start-time .time-preview__cst-container .time").data('time-hour').toString() + ":" + $("#operation_op_completion_5i").val()
    est_op_completion_time = $(".op-prep-start-time .time-preview__est-container .time").data('time-hour').toString() + ":" + $("#operation_op_completion_5i").val()
